 ...
 * @shaker: A pointer to the current node being considered for
 *            swapping in the cocktail shaker algorithm.
 */
 ...
 *           in the cocktail shaker algorithm.
 */
